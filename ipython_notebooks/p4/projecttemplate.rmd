...
join_years = seq(1996,2015,1)

common.categories = list(as.character(unique(filter(
  academy.winners, Year_numeric == 1995)$Award)))
dropped.categories = list()

common.categories
list(as.character(unique(filter(academy.winners, Year_numeric == 1999)$Award)))

setdiff(as.character(list(
  unique(filter(academy.winners, Year_numeric == 1999)$Award))),
   common.categories)
