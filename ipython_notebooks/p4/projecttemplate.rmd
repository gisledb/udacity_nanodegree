...
academy_replace_script_name <- c(
  'Les Mis<e9>rables' = 'Les Misérables',
  'Adaptation' = 'Adaptation.')
...
subset(academy.winners, grepl('arnia', academy.winners$Name))

subset(script_summary,grepl('rab', script_summary$title))
subset(script_summary, script_summary[1] == 2754)

colnames(script_summary)[1]

script_summary[script_summary$script_id == 2754,]

filter(script_summary, grepl('<', script_summary$title))
...
recode(script_summary$title, !!!as.list(academy_replace_script_name)) %>% 
  sort()

View(script_summary)
  
filter(academy.winners, c(Name = 'Whiplash')

typeof(script_replace_academy_name)

as.list(academy_replace_script_name)

x <- sample(c("a", "b", "c"), 10, replace = TRUE)
x
recode(x, a = "Apple")

str(academy.winners.1995.to.2015)

names(academy.winners.1995.to.2015)

nrow(filter(academy.winners.1995.to.2015, Name == 'Ex Machina'))

academy.winners.1995.to.2015[5,][5]

View(academy.winners.1995.to.2015)

str(academy.winners$Film)

levels(academy.winners.1995.to.2015$Name)
