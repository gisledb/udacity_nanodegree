...
```
We see here that there are too many categorical variables for the heatmap to provide much useful information. To improve this I will try to divide the countries into regions instead, using the countrycode library.
```{r}
library(countrycode)
library(dplyr)
...
#Based on the above, I'll make the pre-1900 bins fairly wide
# cut(as.numeric(as.character(fertility.long$year)), 
#    breaks = c(1750,1800,1804,2010,2015))[1000]
cut(as.numeric(as.character(fertility.long$year)), breaks = c(1750,1801,1804,1950,2000,2015))
```
...
ggplot(data = fertility.long, aes(x = year, y = country, color = value)) +
  # geom_point()
  # geom_jitter()
  # geom_count()
  # geom_bin2d()
