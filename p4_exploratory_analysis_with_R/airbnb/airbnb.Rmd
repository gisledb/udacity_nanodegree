...
https://github.com/gisledb/udacity_nanodegree/blob/master/\
p6_data_visualization_with_Tableau/Project/union_script.R.
...
```{r fig.height = 8, fig.width = 8, echo=FALSE, echo=FALSE, message=FALSE, warning=FALSE, Multivariate_Plots}
...
```{r fig.height = 8, fig.width = 8, echo=FALSE, echo=FALSE, message=FALSE, warning=FALSE, Multivariate_Plot}
...
and how many people the unit can accomadate). There is also a clear correlation 
