...
room units have increased and shared room units have decreased.
...
```{r}
ggplot(aes(x=longitude, y=latitude), data=airbnb) +
    geom_point() 

```

[map experiment, expand or remove]
...
# head(airbnb_subset)
# 
# ggpairs(airbnb_subset[sample.int(nrow(airbnb), 1000), ], 
#          cardinality_threshold = nrow(distinct(airbnb,neighborhood)))
# 
# 
# distinct(airbnb,neighborhood) %>% 
#   nrow()
